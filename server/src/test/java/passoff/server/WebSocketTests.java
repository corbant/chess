...
public class WebSocketTests {
    ...
    private void makeMove(WebsocketUser sender, int gameID, ChessMove move, boolean expectSuccess,
        ...
        Map<String, Integer> numExpectedMessages = expectedMessages(sender, senderExpected, inGame, inGameExpected,
                otherClients);
    ...
    private void assertMessages(String username, ServerMessage.ServerMessageType[] expectedTypes,
        ...
        Assertions.assertEquals(expectedTypes.length, messages.size(),
                "For command '%s' user '%s' expected %d messages with types %s, got %d: %s"
